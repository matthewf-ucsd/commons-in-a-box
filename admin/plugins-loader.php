...
class CBox_Plugins {
	...
	private function register_recommended_plugins() {
		...
		self::register_plugin( array(
			...
			'download_url'      => 'http://downloads.wordpress.org/plugin/buddypress-docs.2.0.1.zip',
		...
		if ( is_network_admin() ) :
			...
			self::register_plugin( array(
				...
				'version'           => '1.2.1',
				'download_url'      => 'http://downloads.wordpress.org/plugin/bp-mpo-activity-filter.1.2.1.zip',
	...
	private function register_optional_plugins() {
		...
		self::register_plugin( array(
			...
			'version'           => '1.0-RC6',
			'depends'           => 'BuddyPress (>=1.5)',
			'download_url'      => CBOX_PLUGIN_DIR . 'includes/zip/bp-reply-by-email-1.0-RC6.zip',
	...
	private function register_dependency_plugins() {
		...
		self::register_plugin( array(
			'plugin_name'  => 'BuddyPress',
			'type'         => 'dependency',
			'download_url' => 'http://downloads.wordpress.org/plugin/buddypress.2.9.4.zip'
		) );
	}
